...
class Rest_Ports(IntEnum):
    ...
    """
    scryostation_hlm       = 47101  # /etc/services entry is "cryostation-hlm      47101/tcp"
    cryocore_hlm           = 47101  # /etc/services entry is "cryostation-hlm      47101/tcp"
    ...
    vacuumcontrol_llm      = 47136 # /etc/services entry is "vacuumcontrol-llm     47136/tcp"
    thermalswitch_llm      = 47137 # /etc/services entry is "thermalswitch-llm     47137/tcp"
    ...
    system_hlm             = 47210  # /etc/services entry is "system-hlm           47210/tcp"

    pegasus_hlm            = 47220  #  /etc/services entry is "pegasus-hlm         47220/tcp"
