...
Example usage:
 ...
 cryo.get_prop('/sampleChamber/temperatureControllers/platform/thermometer/sample')['sample']['temperatureAvg1Sec']
...
class SCryostation(genericcryostat.GenericCryostat):
    ...
    def set_run_turbopump_continuously_during_cooldown(self, run):
        return self.set_prop('/controller/properties/runTurbopumpContinuouslyDuringCooldown', run)
    ...
    def get_stage1_temperature(self):
        r = self.get_prop('/cooler/temperatureControllers/stage1/thermometer/properties/sample')
        return r['sample']['temperatureOK'], r['sample']['temperatureAvg1Sec']
    ...
    def get_user2_target_temperature(self):
        r = self.get_prop('/sampleChamber/temperatureControllers/user2/properties/targetTemperature')
        return r['targetTemperature']
    ...
    # Turbopump
    #
    def set_turbopump_precooling_target_pressure(self, target):
        return self.set_prop('/controller/properties/turbopumpPreCoolingTargetPressure', target)
    
    def set_turbopump_precooling_time_limit(self, limit):
        return self.set_prop('/controller/properties/turbopumpPreCoolingTimeLimit', limit)
